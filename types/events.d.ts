...
> = Events[K] extends Array<unknown> ? Events[K] : unknown[];
type EventEmitterCallback<Events, K extends keyof Events> = (
  ...args: Events[K] extends Array<unknown> ? Events[K] : unknown[]
) => void;

declare class EventEmitter<Events> {
  on<K extends keyof Events>(
    event: K,
    callback: EventEmitterCallback<Events, K>
  ): void;
  ...
  emit<K extends keyof Events>(
    event: K,
    ...args: EventEmitterArgs<Events, K>
  ): void;
}
